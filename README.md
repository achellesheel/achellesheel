...
*Only the projects that survived all three tasks get to keep the Cup.*

| Trial | Project | The Challenge |
|---|---|---|
| 🐉 **The Dragon** | [research-agent](https://github.com/achellesheel/research-agent) | LangGraph-orchestrated research agent — tool use (web search + arXiv), persistent memory (SQLite + FAISS), structured briefs. Faced down the hardest task first. |
| 🌊 **The Black Lake** | [multilingual-rag-eval](https://github.com/achellesheel/multilingual-rag-eval) | Multilingual RAG evaluation across Hindi and English — dove deep for retrieval that actually holds up, custom eval metrics, $0 cost. |
...
<img src="https://github-readme-stats.vercel.app/api?username=achellesheel&show_icons=true&theme=radical&hide_border=true&count_private=true" alt="Pranav's GitHub stats" height="165"/>
